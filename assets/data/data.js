...
export const tech = [
    ...
    {"name" : "Django REST Framework", "img" : django, "percentage" : "90", "flag":true, "end":"backend"},
    ...
    {"name" : "MongoDB", "img" : mongodb, "percentage" : "60", "flag":true, "end":"backend"},
    {"name" : "MySQL", "img" : mysql, "percentage" : "70", "flag":true, "end":"backend"},
    {"name" : "Postman", "img" : postman, "percentage" : "60", "flag":true, "end":"backend"},
    {"name" : "GitHub", "img" : git, "percentage" : "70", "flag":true, "end":"backend"},
    {"name" : "PythonAnywhere", "img" : pythonanywhere, "percentage" : "80", "flag":true, "end":""},
    {"name" : "Machine Learning", "img" : ml, "percentage" : "50", "flag":true, "end":""},
    {"name" : "Data Structures", "img" : "", "percentage" : "90", "flag":false, "end":"problemsolver"},
    {"name" : "Algorithms", "img" : "", "percentage" : "70", "flag":false, "end":"problemsolver"},
    {"name" : "Problem-Solving", "img" : "", "percentage" : "80", "flag":false, "end":"problemsolver"},
    {"name" : "LeetCode", "img" : "", "percentage" : 650, "flag":false, "end":"problemsolver"}
]
